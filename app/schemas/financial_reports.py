...
class MetricaComisiones(BaseModel):
    ...
    porcentaje_promedio: Decimal = Field(..., description="Porcentaje promedio aplicado")
...
class ReporteVendedor(BaseModel):
    ...
    porcentaje_comision_promedio: Decimal = Field(..., description="% comisión promedio")

# Schemas para dashboard ejecutivo
class DashboardFinanciero(BaseModel):
    """Dashboard financiero completo"""
    fecha_generacion: datetime = Field(..., description="Fecha de generación del reporte")
