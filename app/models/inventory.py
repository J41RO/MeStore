...
class Inventory(BaseModel):
    ...
    # Relación con Storage (opcional)
    # Permite asociar el inventario a una ubicación física específica
    ...
    # Relación con User para tracking de quién actualizó el inventario
    # Esto permite saber quién realizó la última modificación
    # y es útil para auditoría y control de cambios
    # También permite mantener un historial de cambios por usuario
    # y facilita la trazabilidad de acciones en el inventario
    user = relationship(
        "User",
        back_populates="ubicaciones_inventario",
    ...
    # Relationship con Transaction para transacciones relacionadas
    ...
    __table_args__ = (
        ...
        Index('ix_inventory_updated_by_product', 'updated_by_id', 'product_id'),  # Inventario por usuario
        Index('ix_inventory_storage_product', 'storage_id', 'product_id'),  # Inventario por storage
        Index('ix_inventory_updated_at', 'updated_at'),  # Temporal
        Index('ix_inventory_updated_by_status', 'updated_by_id', 'status'),  # Usuario + estado
