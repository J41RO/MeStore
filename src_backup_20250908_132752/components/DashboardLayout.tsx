...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Productos', href: '/productos', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10' },
    { name: 'Órdenes', href: '/ordenes', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      ...
      `}>
        <div className="flex items-center justify-center h-16 px-4 bg-blue-600 dark:bg-blue-700">
          <h1 className="text-xl font-bold text-white">MeStore</h1>
        </div>
