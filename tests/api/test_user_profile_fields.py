...
class TestUserProfileFields:
    ...
    def test_user_model_has_empresa_direccion_fields(self):
        ...
        # User model has evolved to 78 columns with OAuth, banking, and vendor management fields
        assert len(columns) == 78, f"Esperado 78 columnas del modelo User completo, encontrado {len(columns)}"
