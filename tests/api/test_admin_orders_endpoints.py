...
@pytest.mark.asyncio
async def test_get_all_orders_requires_superuser(async_client: AsyncClient):
...
@pytest.mark.asyncio
async def test_get_all_orders_success(async_client: AsyncClient, superuser_token: str, sample_order: Order):
...
@pytest.mark.asyncio
async def test_get_all_orders_with_filters(async_client: AsyncClient, superuser_token: str, sample_order: Order):
...
@pytest.mark.asyncio
async def test_get_order_detail_success(async_client: AsyncClient, superuser_token: str, sample_order: Order):
...
@pytest.mark.asyncio
async def test_get_order_detail_not_found(async_client: AsyncClient, superuser_token: str):
...
@pytest.mark.asyncio
async def test_update_order_status_success(async_client: AsyncClient, superuser_token: str, sample_order: Order):
...
@pytest.mark.asyncio
async def test_update_order_status_invalid_status(async_client: AsyncClient, superuser_token: str, sample_order: Order):
...
@pytest.mark.asyncio
async def test_cancel_order_success(async_client: AsyncClient, superuser_token: str, sample_order: Order):
...
@pytest.mark.asyncio
async def test_get_order_stats_success(async_client: AsyncClient, superuser_token: str, sample_order: Order):
...
@pytest.mark.asyncio
async def test_admin_orders_pagination(async_client: AsyncClient, superuser_token: str, sample_order: Order):
...
@pytest.mark.asyncio
async def test_admin_orders_search(async_client: AsyncClient, superuser_token: str, sample_order: Order):
