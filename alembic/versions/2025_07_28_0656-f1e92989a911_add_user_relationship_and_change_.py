"""add user relationship and change tracking to products

Revision ID: f1e92989a911
Revises: 74cbefbb7ae0
Create Date: 2025-07-28 06:56:48.687250+00:00
...
revision: str = 'f1e92989a911'
down_revision: Union[str, Sequence[str], None] = '74cbefbb7ae0'
...
def upgrade() -> None:
    ...
    op.add_column('products', sa.Column('vendedor_id', sa.UUID(), nullable=True, comment='ID del usuario vendedor que registró el producto'))
    op.add_column('products', sa.Column('created_by_id', sa.UUID(), nullable=True, comment='ID del usuario que creó el producto'))
    op.add_column('products', sa.Column('updated_by_id', sa.UUID(), nullable=True, comment='ID del usuario que actualizó por última vez'))
    op.add_column('products', sa.Column('version', sa.Integer(), nullable=False, comment='Versión del producto para control de cambios'))
    ...
    op.create_foreign_key(None, 'products', 'users', ['vendedor_id'], ['id'])
...
def downgrade() -> None:
    ...
    op.drop_column('products', 'vendedor_id')
    # ### end Alembic commands ###
