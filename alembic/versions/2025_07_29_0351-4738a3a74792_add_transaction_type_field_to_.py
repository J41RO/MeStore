...
Revision ID: 4738a3a74792
Revises: b894cfdaf86f
Create Date: 2025-07-29 03:51:00.144747+00:00
...
revision: str = '4738a3a74792'
down_revision: Union[str, Sequence[str], None] = 'b894cfdaf86f'
...
def upgrade() -> None:
    ...
    op.execute("CREATE TYPE transactiontype AS ENUM ('VENTA', 'COMISION', 'DEVOLUCION', 'AJUSTE')")

    op.add_column('transactions', sa.Column('transaction_type', sa.Enum('VENTA', 'COMISION', 'DEVOLUCION', 'AJUSTE', name='transactiontype'), nullable=False, comment='Tipo de transacción del marketplace'))
