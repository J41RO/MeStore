...
Revision ID: f5aaae464350
Revises: cc376e0d460c
Create Date: 2025-07-28 05:33:43.194922+00:00
...
revision: str = 'f5aaae464350'
down_revision: Union[str, Sequence[str], None] = 'cc376e0d460c'
...
def upgrade() -> None:
    ...
    op.add_column('products', sa.Column('precio_venta', sa.DECIMAL(precision=10, scale=2), nullable=True, comment='Precio de venta al público (COP)'))
    op.add_column('products', sa.Column('precio_costo', sa.DECIMAL(precision=10, scale=2), nullable=True, comment='Precio de costo/compra del producto (COP)'))
    op.add_column('products', sa.Column('comision_mestocker', sa.DECIMAL(precision=10, scale=2), nullable=True, comment='Comisión de MeStore por venta del producto (COP)'))
...
def downgrade() -> None:
    ...
    op.alter_column('products', 'sku',
               ...
               existing_comment='Código único del producto para identificación',
               existing_nullable=False)
    op.drop_column('products', 'comision_mestocker')
