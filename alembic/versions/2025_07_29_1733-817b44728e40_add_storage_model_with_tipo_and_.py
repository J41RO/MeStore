"""Add Storage model with tipo and capacidad_max fields

Revision ID: 817b44728e40
Revises: 060068edef71
Create Date: 2025-07-29 17:33:01.430206+00:00
...
revision: str = "817b44728e40"
down_revision: Union[str, Sequence[str], None] = "060068edef71"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_storage_tipo_capacidad", "storages", ["tipo", "capacidad_max"], unique=False
    )
    ...
    op.alter_column(
        ...
        "status",
        existing_type=postgresql.ENUM(
            "TRANSITO", "VERIFICADO", "DISPONIBLE", "VENDIDO", name="productstatus"
        ),
        type_=sa.Enum(
            "TRANSITO", "VERIFICADO", "DISPONIBLE", "VENDIDO", name="productstatus"
        ),
    ...
    op.alter_column(
        ...
        "transaction_type",
        existing_type=postgresql.ENUM(
            "VENTA", "COMISION", "DEVOLUCION", "AJUSTE", name="transactiontype"
        ),
        type_=sa.Enum(
            "VENTA", "COMISION", "DEVOLUCION", "AJUSTE", name="transactiontype"
        ),
    ...
    op.alter_column(
        ...
        "user_type",
        existing_type=postgresql.ENUM(
            "SUPERUSER", "ADMIN", "VENDEDOR", "COMPRADOR", name="usertype"
        ),
...
def downgrade() -> None:
    ...
    op.alter_column(
        ...
        existing_type=sa.Enum(
            "COMPRADOR", "VENDEDOR", "ADMIN", "SUPERUSER", name="usertype"
        ),
