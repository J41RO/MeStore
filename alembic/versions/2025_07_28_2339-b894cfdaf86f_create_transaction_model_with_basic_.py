"""create transaction model with basic fields

Revision ID: b894cfdaf86f
Revises: 720d7c9fb58f
Create Date: 2025-07-28 23:39:35.892991+00:00
...
revision: str = 'b894cfdaf86f'
down_revision: Union[str, Sequence[str], None] = '720d7c9fb58f'
...
def upgrade() -> None:
    ...
    sa.Column('comprador_id', sa.UUID(), nullable=False, comment='ID del usuario comprador'),
    sa.Column('vendedor_id', sa.UUID(), nullable=True, comment='ID del usuario vendedor (nullable para transacciones del sistema)'),
    sa.Column('product_id', sa.UUID(), nullable=True, comment='ID del producto involucrado en la transacción'),
...
def downgrade() -> None:
    ...
    op.alter_column('inventory', 'condicion_producto',
               ...
               server_default=sa.text("'NUEVO'::condicionproducto"),
    ...
    op.alter_column('inventory', 'status',
               ...
               server_default=sa.text("'DISPONIBLE'::inventorystatus"),
