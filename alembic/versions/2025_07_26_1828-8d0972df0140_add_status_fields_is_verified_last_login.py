"""add status fields is_verified last_login

Revision ID: 8d0972df0140
Revises: dade20b7efdd
Create Date: 2025-07-26 18:28:54.219886+00:00
...
revision: str = '8d0972df0140'
down_revision: Union[str, Sequence[str], None] = 'dade20b7efdd'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('is_verified', sa.Boolean(), nullable=False, comment='Indica si el usuario ha verificado su email'))
    op.add_column('users', sa.Column('last_login', sa.DateTime(timezone=True), nullable=True, comment='Timestamp del último login del usuario'))
