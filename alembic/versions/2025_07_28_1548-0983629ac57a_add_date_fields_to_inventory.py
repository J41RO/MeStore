"""add date fields to inventory

Revision ID: 0983629ac57a
Revises: c8445df379aa
Create Date: 2025-07-28 15:48:13.038370+00:00
...
revision: str = '0983629ac57a'
down_revision: Union[str, Sequence[str], None] = 'c8445df379aa'
...
def upgrade() -> None:
    ...
    op.add_column('inventory', sa.Column('fecha_ingreso', sa.DateTime(), nullable=False, comment='Fecha de ingreso del producto al inventario'))
    op.add_column('inventory', sa.Column('fecha_ultimo_movimiento', sa.DateTime(), nullable=False, comment='Fecha del último movimiento de stock'))
...
def downgrade() -> None:
    ...
    op.alter_column('inventory', 'product_id',
               ...
               existing_comment='ID del producto en inventario',
               existing_nullable=False)
    op.drop_column('inventory', 'fecha_ultimo_movimiento')
    op.drop_column('inventory', 'fecha_ingreso')
    # ### end Alembic commands ###
