"""add_status_fecha_pago_referencia_pago_fields_to_transaction

Revision ID: 060068edef71
Revises: f5b5d83fa63d
Create Date: 2025-07-29 05:51:00.354854+00:00
...
revision: str = '060068edef71'
down_revision: Union[str, Sequence[str], None] = 'f5b5d83fa63d'
...
def upgrade() -> None:
    ...
    op.alter_column('products', 'deleted_at',
               ...
               existing_comment='Fecha de eliminación lógica (soft delete)',
               existing_nullable=True)
    op.add_column('transactions', sa.Column('status', sa.String(length=50), nullable=True, comment='Estado adicional específico del procesador de pagos'))
    op.add_column('transactions', sa.Column('fecha_pago', sa.DateTime(), nullable=True, comment='Fecha y hora cuando se realizó el pago efectivo'))
    op.add_column('transactions', sa.Column('referencia_pago', sa.String(length=100), nullable=True, comment='Referencia específica del pago (diferente a referencia_externa)'))
...
def downgrade() -> None:
    ...
    op.alter_column('transactions', 'monto',
               ...
               existing_comment='Monto de la transacción en pesos colombianos (COP)',
               existing_nullable=False)
    op.drop_column('transactions', 'referencia_pago')
    op.drop_column('transactions', 'fecha_pago')
