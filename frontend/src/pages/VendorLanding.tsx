      ...
      <section className='px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8'>
        <div className='text-center'>
          ...
          <p className='mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600 dark:text-gray-300'>
            Conecta con miles de clientes, aumenta tus ventas y haz crecer tu
            negocio con nuestras herramientas avanzadas.
          </p>
      ...
      >
        <div className='text-center mb-16'>
          ...
          <p className='mx-auto mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-300'>
            Descubre los beneficios exclusivos que ofrecemos a nuestros
            vendedores
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4'>
          ...
          <div className='text-center p-6 bg-white dark:bg-gray-800 shadow-lg rounded-xl hover:shadow-xl transition-shadow duration-300'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Hasta 15% de comisión por venta. Las mejores tarifas del mercado
          ...
          <div className='text-center p-6 bg-white dark:bg-gray-800 shadow-lg rounded-xl hover:shadow-xl transition-shadow duration-300'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Accede a miles de clientes potenciales en múltiples países y
          ...
          <div className='text-center p-6 bg-white dark:bg-gray-800 shadow-lg rounded-xl hover:shadow-xl transition-shadow duration-300'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Analytics avanzados, gestión de inventario, automatización de
              pedidos y mucho más.
            </p>
          </div>
          ...
          <div className='text-center p-6 bg-white dark:bg-gray-800 shadow-lg rounded-xl hover:shadow-xl transition-shadow duration-300'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Equipo de soporte dedicado 24/7, capacitación gratuita y recursos
      ...
      <section className='px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8'>
        <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 md:p-12 text-center text-white'>
          ...
          <p className='text-xl mb-8 text-blue-100 max-w-2xl mx-auto'>
            Únete a miles de vendedores que ya están creciendo con nosotros. El
            registro es gratis y puedes comenzar a vender inmediatamente.
          </p>
          <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
            ...
            <button className='border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-4 text-lg font-semibold rounded-lg transition-all duration-200 w-full sm:w-auto'>
