...
ALTERNATIVA INMEDIATA: Usa localhost:5173 en lugar de 192.168.1.137:5173`;
  ...
  const handleOTPVerification = async () => {
    ...
    // Get phone number from form data (already in E.164 format from registration)
    const phoneNumber = basicFormData?.telefono;
    if (!phoneNumber) {
      setOtpError('Error: Número de teléfono no encontrado. Reinicia el proceso.');
      return;
    }
