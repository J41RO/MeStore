    ...
    <div className="min-h-screen bg-neutral-50 p-4 sm:p-6 lg:p-8">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8">
        ...
        <Card variant="elevated">
          <Card.Header>
            <h3 className="text-lg sm:text-xl font-semibold">Card Responsivo</h3>
          </Card.Header>
          <Card.Body>
        ...
        <Card variant="outlined">
          <Card.Header>
            <h3 className="text-lg sm:text-xl font-semibold">Buttons Responsivos</h3>
          </Card.Header>
          <Card.Body>
        ...
        <Card variant="default">
          <Card.Header>
            <h3 className="text-lg sm:text-xl font-semibold">Inputs Responsivos</h3>
          </Card.Header>
          <Card.Body>
      ...
      <div className="max-w-7xl mx-auto">
        <Card variant="elevated">
          <Card.Header>
            <h3 className="text-lg sm:text-xl font-semibold">Typography Responsiva</h3>
          </Card.Header>
          <Card.Body>
            <div className="space-y-4">
