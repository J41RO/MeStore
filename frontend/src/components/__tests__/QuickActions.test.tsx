...
describe('QuickActions Component', () => {
  ...
  test('AddProduct form can be filled and submitted', async () => {
    ...
    // Verificar que se llama console.log (mock del envío)
    expect(mockConsoleLog).toHaveBeenCalledWith('Producto a crear:', expect.objectContaining({
      name: 'Producto Test',
      price: '99.99',
  ...
  test('AddProduct form validates required fields', async () => {
    ...
    // Los campos requeridos deben tener atributo required
