...
describe('ForgotPassword Component', () => {
  ...
  test('handles successful password recovery request', async () => {
    ...
    expect(screen.getByText(/se ha enviado un enlace de recuperación a/i)).toBeInTheDocument();
  ...
  test('handles API error response', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Email no encontrado en el sistema')).toBeInTheDocument();
    });
  ...
  test('calls onBackToLogin from success screen', async () => {
    ...
    const backButtonSuccess = screen.getByRole('button', { name: /volver al login/i });
