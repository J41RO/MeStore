...
describe('LoginForm', () => {
  ...
  describe('Validación de email', () => {
    ...
    test('no muestra error para email válido', async () => {
      ...
      expect(
        screen.queryByText(/por favor ingresa un email válido/i)
  ...
  describe('Validación de password', () => {
    test('muestra error para password que no cumple requisitos', async () => {
      ...
      expect(
        screen.getByText(/mínimo 8 caracteres, 1 mayúscula y 1 número/i)
      ).toBeInTheDocument();
    });
    ...
    test('no muestra error para password válido', async () => {
      ...
      expect(
        screen.queryByText(/mínimo 8 caracteres, 1 mayúscula y 1 número/i)
      ).not.toBeInTheDocument();
    });
  });
  ...
  describe('Submit del formulario', () => {
    test('previene submit cuando formulario es inválido', async () => {
      ...
      expect(
        screen.getByText(/por favor corrige los errores antes de enviar/i)
      ).toBeInTheDocument();
