...
const CommissionReport: React.FC<CommissionReportProps> = ({
  ...
  const { commissions, isLoading, totalCommissions, totalSales, breakdown } =
    useCommissions(defaultFilters);
      ...
      <div className='bg-white rounded-lg shadow-sm border p-6 mb-6'>
        <div className='flex items-center justify-between mb-4'>
          <div>
            ...
            <p className='text-gray-600'>
              Análisis detallado de tus comisiones
            </p>
          </div>
          <ExportModal
        ...
        <div className='flex space-x-1 bg-gray-100 p-1 rounded-lg'>
          <button
            ...
            className={
              currentView === 'summary'
                ? 'bg-white shadow-sm text-blue-600 font-medium px-4 py-2 rounded-md'
                : 'text-gray-600 hover:text-gray-900 px-4 py-2 rounded-md'
            }
          >
            Resumen
          </button>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-6'>
              <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
                ...
                <p className='text-2xl font-bold text-blue-900'>
                  ...
                  {commissions.length > 0
                    ? (totalCommissions / commissions.length).toFixed(2)
                    : '0.00'}
                </p>
              ...
              <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
                ...
                <p className='text-xs text-yellow-600'>
                  Confirmadas de {commissions.length}
                </p>
              </div>
            </div>
