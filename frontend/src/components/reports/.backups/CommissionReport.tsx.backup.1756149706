...
const CommissionReport: React.FC<CommissionReportProps> = ({
 ...
 const { commissions, isLoading, totalCommissions, totalSales } = useCommissions(defaultFilters);
     ...
     <div className="bg-white rounded-lg shadow-sm border p-6">
       ...
       {currentView === 'table' && (
         <div>
           ...
           <p className="text-gray-600">Componente de tabla - Próximamente en Micro-Fase 4</p>
         </div>
       )}
       ...
       {currentView === 'charts' && (
         <div>
           ...
           <p className="text-gray-600">Componente de gráficos - Próximamente en Micro-Fase 4</p>
         </div>
       )}
     </div>
   </div>
