...
describe('Input Component', () => {
  ...
  test('should apply default state styles', () => {
    ...
    expect(input).toHaveClass('border-neutral-300', 'focus:border-primary-500', 'focus:ring-primary-500');
  });
  ...
  test('should use provided ID when given', () => {
    render(<Input id="custom-id" label="Custom ID Label" placeholder="Custom ID input" />);
