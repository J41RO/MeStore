      ...
      >
        {filteredImages.map((image, index) => (
          <div
            ...
            style={{
              width: currentViewMode === 'grid' ? thumbnailSize : 'auto',
            }}
            draggable={allowReorder}
            onDragStart={
              allowReorder ? e => handleImageDragStart(e, index) : undefined
            }
              ...
              <div className='flex gap-2'>
                {onToggleFavorite && (
                  ...
                  >
                    <span
                      className={
                        image.favorite ? 'text-red-500' : 'text-gray-500'
                      }
                    >
                      ♥
                    </span>
