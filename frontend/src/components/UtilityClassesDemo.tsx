      ...
      <div className="section-mestocker">
        ...
        <div className="mb-8">
          ...
          <div className="grid-mestocker grid-cols-1 md:grid-cols-3">
            <div className="card-mestocker">
              ...
              <p className="text-neutral-600">Contenido de la primera tarjeta</p>
            </div>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-mestocker-secondary">Texto secundario MeStocker</p>
            <h3 className="heading-mestocker text-xl">Heading MeStocker</h3>
            <h4 className="subheading-mestocker text-lg">Subheading MeStocker</h4>
          </div>
        </div>
      </div>
    </div>
