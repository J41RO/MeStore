        ...
        <Card className="mt-8">
          ...
          <Card.Body>
            <ul className="space-y-2 text-sm text-neutral-600 dark:text-neutral-400">
              <li>✅ <strong>Manual Toggle:</strong> Click the theme button to cycle through light → dark → system</li>
              <li>✅ <strong>System Detection:</strong> Automatically follows your OS preference when set to 'system'</li>
              <li>✅ <strong>Persistence:</strong> Your choice is saved in localStorage</li>
              <li>✅ <strong>Smooth Transitions:</strong> CSS transitions for seamless theme switching</li>
              <li>✅ <strong>Component Support:</strong> All MeStocker components adapt to dark mode</li>
            </ul>
          </Card.Body>
        </Card>
      </div>
