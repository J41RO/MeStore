...
try:
    from ..base_operation import BaseOperation, OperationType, OperationStatus, OperationResult, OperationContext
except ImportError:
    # Fallback imports for standalone usage
    from core.operations.base_operation import BaseOperation, OperationType, OperationStatus, OperationResult, OperationContext
...
def create_file_with_template(filepath: str, template: str, variables: Dict[str, str] = None) -> bool:
...
def create_file_v53(filepath: str, content: str = "", backup: bool = True) -> Dict[str, Any]:
