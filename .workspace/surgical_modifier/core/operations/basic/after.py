...
class AfterOperation(BaseOperation):
    ...
    def _perform_after_insertion(self, content: str, pattern: str, insertion: str,
    ...
    def insert_after_v53(self, file_path: str, pattern: str, content: str, 
...
def insert_after(target_file: str, pattern: str, content: str, **kwargs) -> OperationResult:
    """
...
def insert_after_regex(target_file: str, pattern: str, content: str, **kwargs) -> OperationResult:
    """
...
def insert_after_v53(file_path: str, pattern: str, content: str, 
                     regex_mode: bool = False, **kwargs) -> OperationResult:
    """
    ...
    Returns:
        OperationResult with v5.3 compatibility
    """
    return after_operation.insert_after_v53(file_path, pattern, content, regex_mode, **kwargs)
