// ~/MeStore/frontend/src/components/Testform.tsx
// ---------------------------------------------------------------------------------------------
// MESTORE - Testform Component
// Copyright (c) 2025 Jairo. Todos los derechos reservados.
// Licensed under the proprietary license detailed in a LICENSE file in the root of this project.
// ---------------------------------------------------------------------------------------------
//
// Nombre del Archivo: Testform.tsx
// Ruta: ~/MeStore/frontend/src/components/Testform.tsx
// Autor: Jairo
// Fecha de Creación: 2025-09-09 01:32:09
// Última Actualización: 2025-09-09 01:32:09
// Versión: 1.0.0
  ...
  return (
    <div className="max-w-md mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
        {mode === 'create' ? 'Create' : 'Edit'} Testform
      </h2>
